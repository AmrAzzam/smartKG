...
public class ReorderTransformationLDF extends ReorderTransformationSubstitution {
    ...
    */
    ...
    {
       // System.out.println("Before getStatisticsHandler");
        this.stats = graph.getStatisticsHandler();
       // System.out.println("After getStatisticsHandler");
       // System.out.println("Before graph Size");
        // Calling function graph.size() calles the function getBaseFragment () in LDFClient Class
       // So technically it works as an initializer
       numTriples = graph.size();
      // numTriples = 0;
       //  System.out.println("After graph Size");
        multiTermMax = numTriples/100;
       // System.out.println("before initializeMatcher");
        initializeMatcher();
    ...
    private void initializeMatcher() {
      ...
      //  System.out.println("Reorderoing: " + matcher.toString());
    }

    @Override
    protected double weight(PatternTriple pt)
    {
      //  System.out.println("ana weight: " + pt.toString());
