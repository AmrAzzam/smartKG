...
public class LinkedDataFragment {
    ...
    public LinkedDataFragment(Triple m, Long matchCount) {
        ...
        //System.out.println("Triple m, Long matchCount");
        this.tripleMatch = m;
        Graph g = GraphFactory.createJenaDefaultGraph();
        if(matchCount > 0) {
            g.add(m);
    ...
    public LinkedDataFragment(ExtendedIterator<Triple> triples, Triple m) {
         // System.out.println("ExtendedIterator<Triple> triples, Triple m");
    ...
    public LinkedDataFragment(Iterator<Triple> triples, Long matchCount, Triple m) {
       ...
       // System.out.println("Iterator<Triple> triples, Long matchCount, Triple m");
       // System.out.println( matchCount +  " " +  m);
       // System.out.println("Linked Data Fragment Constractor m: "+m);
       // System.out.println("Linked Data Fragment Constractor matchCount: "+ matchCount);

      //  System.out.println("triples: " + triples.next().toString());
